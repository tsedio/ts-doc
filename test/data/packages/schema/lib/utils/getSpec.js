            ...
            operationStore.operation.operationPaths.forEach(({ path, method }) => {
                if (method) {
                    mergeOperation_1.mergeOperation(specJson, operation, {
                        ...
                        defaultTags,
                        tags,
                        operationId: (path) => { var _a; return (_a = options.operationIdFormatter) === null || _a === void 0 ? void 0 : _a.call(options, operationStore.parent.schema.get("name") || operationStore.parent.targetName, operationStore.propertyName, path); }
                    });
                }
            });
        });
